...
export interface RoleConfig {
  ...
  interval?: string; // for cron session types
}
...
export interface ProjectsConfig {
  ...
  resource_competition: string; // role that allocates
...
export interface TeamMember {
  id: string;
  role?: string; // team-internal role, optional
  session_id: string;
  model_tier: ModelTier;
...
export interface RuntimeAdapter {
  ...
  spawnAgent(config: SpawnConfig): Promise<string>; // returns session ID
  ...
  /** Schedule a cron job */
  scheduleCron(config: CronConfig): Promise<string>; // returns job ID
...
export interface ChannelAdapter {
  /** Create a channel */
  createChannel(name: string, purpose: string): Promise<string>; // returns channel ID

  /** Post a message to a channel */
  postMessage(channelId: string, message: string, tags?: string[]): Promise<string>; // returns message ID
